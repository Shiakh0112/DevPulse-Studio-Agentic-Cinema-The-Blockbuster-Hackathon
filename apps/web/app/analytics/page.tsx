  ...
  return (
    <div className="space-y-8 max-w-7xl mx-auto pb-16">
      ...
      <section className="space-y-3">
        ...
        <div className="flex items-center justify-center gap-1.5 text-xs text-text-secondary font-mono pt-1">
          <Info className="w-3.5 h-3.5 text-accent-DEFAULT" />
      ...
      {!loading && !hasAnyData && (
        <div className="p-8 bg-bg-main border border-border-subtle rounded-2xl text-center space-y-3 shadow-xl">
          <AlertCircle className="w-10 h-10 text-accent-DEFAULT mx-auto animate-bounce" />
          <h3 className="text-lg font-bold text-text-primary">No data yet — trigger a crash to see analytics</h3>
      ...
      <div className="space-y-8">
        ...
        <section className="space-y-3">
          <div className="flex items-center gap-2 border-b border-border-subtle/80 pb-2">
            <Activity className="w-5 h-5 text-accent-DEFAULT" />
            <div>
              <h2 className="text-lg font-bold text-text-primary">Hourly Crash Rate</h2>
          ...
          {loading ? (
            <div className="p-8 bg-bg-main rounded-xl border border-border-subtle text-center text-text-secondary font-mono text-xs">
        ...
        <section className="space-y-3">
          <div className="flex items-center gap-2 border-b border-border-subtle/80 pb-2">
            ...
            <div>
              <h2 className="text-lg font-bold text-text-primary">Mean Time To Resolution Trend</h2>
              <p className="text-xs text-text-secondary">
        ...
        <section className="space-y-3">
          <div className="flex items-center gap-2 border-b border-border-subtle/80 pb-2">
            ...
            <div>
              <h2 className="text-lg font-bold text-text-primary">Top Error Types (24h)</h2>
              <p className="text-xs text-text-secondary">
