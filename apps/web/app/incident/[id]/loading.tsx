  ...
  return (
    <div className="max-w-6xl mx-auto space-y-8 pb-16 animate-pulse">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="md:col-span-2 h-48 bg-slate-800/60 rounded-xl border border-slate-800"></div>
        <div className="h-48 bg-slate-800/60 rounded-xl border border-slate-800"></div>
      </div>

      {/* Timeline Skeleton */}
      <div className="h-64 bg-slate-800/60 rounded-xl border border-slate-800"></div>
    </div>
  );
}
