...
export default function FeedLoadingSkeleton() {
  return (
    <div className="min-h-screen bg-[#0B0E14] p-6 md:p-10 space-y-8 animate-pulse">
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="flex items-center justify-between border-b border-[#1F293D] pb-6">
          ...
          <div className="h-9 w-32 bg-[#121824] rounded-lg"></div>
        </div>

        {/* Filter Bar Skeleton */}
        <div className="bg-[#121824]/50 border border-[#1F293D] rounded-xl p-5 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-4">
          {[...Array(5)].map((_, i) => (
            <div key={i} className="space-y-2">
              <div className="h-3 w-16 bg-slate-700/60 rounded"></div>
              <div className="h-10 bg-[#0B0E14]/80 rounded-lg border border-[#1F293D]"></div>
            </div>
          ))}
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {[...Array(6)].map((_, i) => (
            <div key={i} className="bg-[#121824]/60 border border-[#1F293D] rounded-xl p-5 space-y-4 shadow-lg">
              ...
              <div className="h-16 bg-[#0B0E14]/80 rounded-lg border border-[#1F293D]"></div>
              <div className="flex justify-between pt-2 border-t border-[#1F293D]/40">
