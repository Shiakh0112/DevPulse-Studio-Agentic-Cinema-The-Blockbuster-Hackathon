...
export const RoiWidget: React.FC<RoiWidgetProps> = ({
  ...
  return (
    <div className="bg-slate-900/90 border border-emerald-500/50 shadow-[0_0_20px_rgba(16,185,129,0.15)] rounded-2xl p-6 space-y-4">
      {/* 4-Column Responsive Grid (stacks to 2x2 on mobile) */}
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
        {/* Stat Block 1: Developer Hours Saved */}
        <div className="bg-slate-950/80 border border-slate-800 rounded-xl p-4 flex flex-col justify-between space-y-3 hover:border-emerald-500/50 hover:bg-slate-900/80 transition-all duration-200 group">
          ...
          <div>
            ...
            <p className="text-[11px] text-slate-500 mt-1 font-mono">Direct labor time recovered</p>
          </div>
        </div>
        ...
        <div className="bg-slate-950/80 border border-slate-800 rounded-xl p-4 flex flex-col justify-between space-y-3 hover:border-emerald-500/50 hover:bg-slate-900/80 transition-all duration-200 group">
          ...
          <div>
            ...
            <p className="text-[11px] text-slate-500 mt-1 font-mono">At $85/hr developer velocity rate</p>
          </div>
        </div>

        {/* Stat Block 3: MTTR Reduction */}
        <div className="bg-slate-950/80 border border-slate-800 rounded-xl p-4 flex flex-col justify-between space-y-3 hover:border-amber-500/50 hover:bg-slate-900/80 transition-all duration-200 group">
          <div className="flex items-center justify-between">
            <span className="text-xs font-semibold text-slate-400 uppercase tracking-wider">
              MTTR Reduction
            </span>
            <div className="p-2 rounded-xl bg-amber-500/10 border border-amber-500/30 text-amber-400 group-hover:scale-110 group-hover:bg-amber-500/20 transition-all shadow-md">
              <TrendingUp className="w-5 h-5" />
            </div>
          </div>
          <div>
            <div className="text-2xl md:text-3xl font-black text-amber-400 font-mono tracking-tight">
              {calcMttrPercent}% <span className="text-sm font-sans font-semibold text-amber-300">Faster</span>
            </div>
            <p className="text-[11px] text-slate-500 mt-1 font-mono">Reduction in time-to-resolution</p>
          </div>
        </div>

        {/* Stat Block 4: Incidents Auto-Resolved */}
        <div className="bg-slate-950/80 border border-slate-800 rounded-xl p-4 flex flex-col justify-between space-y-3 hover:border-indigo-500/50 hover:bg-slate-900/80 transition-all duration-200 group">
          <div className="flex items-center justify-between">
            <span className="text-xs font-semibold text-slate-400 uppercase tracking-wider">
          ...
          <div>
            ...
            <p className="text-[11px] text-slate-500 mt-1 font-mono">Self-healed without manual toil</p>
          </div>
        </div>
      </div>
